...
<div class="page-header">
    <div class="page-header-row">
        <h1 class="page-title">Edit Extension: {{ $extension->extension_number }}</h1>
    </div>
</div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.extensions.update', $extension) }}">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input @error('extension_number') is-invalid @enderror" id="extension_number" name="extension_number" value="{{ old('extension_number', $extension->extension_number) }}" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-input @error('display_name') is-invalid @enderror" id="display_name" name="display_name" value="{{ old('display_name', $extension->display_name) }}">
            ...
            <div class="form-group">
                <div class="checkbox-item">
                    <input type="checkbox" class="checkbox-input" id="is_active" name="is_active" value="1" {{ old('is_active', $extension->is_active) ? 'checked' : '' }}>
