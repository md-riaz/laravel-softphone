...
<div class="row">
    <div class="col-lg-8">
        <div class="card form-card">
            <div class="card-header"><i class="bi bi-telephone-plus me-2"></i>Extension Details</div>
            <div class="card-body">
                <form method="POST" action="{{ route('admin.extensions.store') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('extension_number') is-invalid @enderror" id="extension_number" name="extension_number" value="{{ old('extension_number') }}" required>
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i> Create Extension</button>
