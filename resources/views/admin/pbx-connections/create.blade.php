                ...
                <form method="POST" action="{{ route('admin.pbx-connections.store') }}">
                    ...
                    <div class="row">
                        <div class="col-md-8 mb-3">
                            ...
                            <input type="text" class="form-control @error('host') is-invalid @enderror" id="host" name="host" value="{{ old('host') }}" placeholder="pbx.example.com" required>
                            @error('host')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                        <div class="col-md-4 mb-3">
                            <label for="port" class="form-label fw-semibold">Port <span class="text-danger">*</span></label>
                            <input type="number" class="form-control @error('port') is-invalid @enderror" id="port" name="port" value="{{ old('port', 5060) }}" required>
                            @error('port')<div class="invalid-feedback">{{ $message }}</div>@enderror
                        </div>
                    </div>
                    <div class="mb-3">
                        <label for="wss_url" class="form-label fw-semibold">WebSocket URL</label>
                        <input type="text" class="form-control @error('wss_url') is-invalid @enderror" id="wss_url" name="wss_url" value="{{ old('wss_url') }}" placeholder="wss://pbx.example.com:8089/ws">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('stun_server') is-invalid @enderror" id="stun_server" name="stun_server" value="{{ old('stun_server') }}" placeholder="stun:stun.example.com:3478">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control @error('turn_server') is-invalid @enderror" id="turn_server" name="turn_server" value="{{ old('turn_server') }}" placeholder="turn:turn.example.com:3478">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('turn_username') is-invalid @enderror" id="turn_username" name="turn_username" value="{{ old('turn_username') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="password" class="form-control @error('turn_password') is-invalid @enderror" id="turn_password" name="turn_password">
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary"><i class="bi bi-check-lg me-1"></i> Create Connection</button>
